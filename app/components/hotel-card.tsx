                ...
                <div className="flex-1 p-5 flex flex-col justify-between">
                    ...
                    <div className="flex items-center gap-3 mt-4 pt-4 border-t border-border">
                        <button className="w-10 h-10 rounded-md border border-border flex items-center justify-center hover:bg-muted active:scale-[0.97] transition-all">
                           ...
                           <Link href={`/app/(main)/single-hotel/${hotel.hotelId}`} className="flex-1 text-center py-3 rounded-md bg-primary text-primary-foreground text-sm font-semibold hover:opacity-90 active:scale-[0.98] transition-all">
                            View Place
                           </Link>
                    </div>
                </div>
